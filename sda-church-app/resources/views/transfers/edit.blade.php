<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <h2 class="font-bold text-2xl text-gray-800 leading-tight">{{ __('Edit Transfer Record') }}</h2>
        </div>
    </x-slot>
    ...
    <div class="py-12 bg-[#fcfdfd] min-h-screen relative overflow-hidden">
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="bg-white rounded-3xl shadow-lg shadow-gray-200/50 border border-gray-100 p-8 relative overflow-hidden">
                ...
                <form action="{{ route('transfers.update', $transfer->transfer_id) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="from_church" value="{{ old('from_church', $transfer->from_church) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="to_church" value="{{ old('to_church', $transfer->to_church) }}"
                                class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:border-primary-500 focus:ring-primary-500 transition-colors sm:text-sm py-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="date" name="request_date" value="{{ old('request_date', $transfer->request_date) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="approval_date" value="{{ old('approval_date', $transfer->approval_date) }}"
                                class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:border-primary-500 focus:ring-primary-500 transition-colors sm:text-sm py-3">
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3"
                            class="w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:border-primary-500 focus:ring-primary-500 transition-colors sm:text-sm">{{ old('notes', $transfer->notes) }}</textarea>
